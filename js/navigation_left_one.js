...
question.addEventListener("click", function(){
    ...
    entry.setAttribute('data-title', "You're sharp if you found this hint. Tip: don't trust everything you see. Besides this notebook, obviously. <p><span class='hidden_text'>*Wrong notebook.</span><p>");
